...
wb = load_workbook('D:\\Software\\Bill-Generator\\excel.xlsx') 

sheet = wb.active 

def excel():
	sheet.cell(row=1, column=1).value = "Mob: 99999-99999"
...
def insert(): 
	if (date.get() == "" and
		...
		# save the file 
		wb.save('D:\\Software\\Bill-Generator\\excel.xlsx') 
...
if __name__ == "__main__": 
	...
	heading = Label(root, text="Aman Computer's", bg="cyan")

	heading2= Label(root, text="Bill Generator", bg="cyan")

	date = Label(root, text="Date", bg="cyan") 

	serial_no = Label(root, text="Serial No", bg="cyan") 

	customer_name = Label(root, text="Customer Name", bg="cyan") 

	designation = Label(root, text="Designation", bg="cyan") 

	particular1_name = Label(root, text="1. Particular Name ", bg="cyan") 

	particular1_qty = Label(root, text="Qty", bg="cyan") 

	particular1_rate = Label(root, text="Rate", bg="cyan") 

	particular2_name = Label(root, text="2. Particular Name ", bg="cyan") 

	particular2_qty = Label(root, text="Qty", bg="cyan") 

	particular2_rate = Label(root, text="Rate", bg="cyan") 

	particular3_name = Label(root, text="3. Particular Name", bg="cyan") 

	particular3_qty = Label(root, text="Qty", bg="cyan") 

	particular3_rate = Label(root, text="Rate", bg="cyan") 

	particular4_name = Label(root, text="4. Particular Name", bg="cyan") 

	particular4_qty = Label(root, text="Qty", bg="cyan") 

	particular4_rate = Label(root, text="Rate", bg="cyan") 

	particular5_name = Label(root, text="5. Particular Name", bg="cyan") 

	particular5_qty = Label(root, text="Qty", bg="cyan") 

	particular5_rate = Label(root, text="Rate", bg="cyan") 
